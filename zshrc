...
#PROMPT=$(echo '%{\033[34m%}%M%{\033[32m%}%/ %{\033[36m%}%n %{\033[01;31m%}>%{\033[33m%}>%{\033[34m%}>%{\033[m%} ')
PROMPT=$(echo '%{\033[36m%}%n %T%{\033[01;31m%}>%{\033[33m%}>%{\033[34m%}>%{\033[m%}')
#}}}
...
# User specific aliases and functions
	...
	alias update201='cd '/mnt/201_server/'`pwd`' # 更新mnt目录 引用命令的值用`命令`
	alias update113='cd '/mnt/113_server/'`pwd`' # 更新mnt目录 引用命令的值用`命令`
